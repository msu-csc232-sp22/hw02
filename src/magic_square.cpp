 ...
 * @brief   Function definitions to implement in this assignment.
 */
 ...
 */
void csc232::PrintTable(int rows, int cols, const csc232::TwoDimArray table)
{
    // TODO: Provide your definition of the PrintTable function here (erase this line when done)
} // end csc232::printTable(int, int, csc232::TwoDimArray)
...
{
    // TODO: Provide your definition of the CalcMagicSquareSum function here (erase this line when done)
    return 0;
} // end csc232::CalcMagicSquareSum(int)
...
{
    // TODO: Provide your definition of the CalcRowTotal function here (erase this line when done)
    return 0;
} // end csc232::CalcRowTotal(const csc232::TwoDimArray, int, int)
...
{
    // TODO: Provide your definition of the CheckRows function here (erase this line when done)
    // HINT: This can be simplified by calling other functions previously written, such as:
    //      CalcRowTotal
    return false;
} // end csc232::CheckRows(csc232::TwoDimArray, int, int)
...
{
    // TODO: Provide your definition of the CalcColTotal function here (erase this line when done)
    return 0;
} // end csc232::CalcColTotal(const csc232::TwoDimArray, int, int)
...
{
    // TODO: Provide your definition of the CheckCols function here (erase this line when done)
    // HINT: This can be simplified by calling other functions previously written, such as:
    //      CalcColTotal
    return false;
} // end csc232::CheckCols(const csc232::TwoDimArray, int, int)
...
{
    // TODO: Provide your definition of the CalcLRDiagTotal function here (erase this line when done)
    return 0;
} // end csc232::CalcLRDiagTotal(const csc232::TwoDimArray, int)
...
{
    // TODO: Provide your definition of the CheckLRDiag function here (erase this line when done)
    // HINT: This can be simplified by calling other functions previously written, such as:
    //      CalcLRDiagTotal
    return false;
} // end csc232::CheckLRDiag(const csc232::TwoDimArray, int, int)
...
{
    // TODO: Provide your definition of the CalcRLDiagTotal function here (erase this line when done)
    return 0;
} // end csc232::CalcRLDiagTotal(const csc232::TwoDimArray, int)
...
{
    // TODO: Provide your definition of the CheckRLDiag function here (erase this line when done)
    // HINT: This can be simplified by calling other functions previously written, such as:
    //      CalcRLDiagTotal
    return false;
} // end csc232::CheckRLDiag(const csc232::TwoDimArray, int, int)
...
{
    // TODO: Provide your definition of the IsMagicSquare function here (erase this line when done)
    // HINT: This can be made quite simple by using other functions such as:
    //      CalcMagicSquareSum
    //      CheckRows
    //      CheckCols
    //      CheckLRDiag
    //      CheckRLDiag
    // TODO: Erase this hint when you have completed this function.
    return false;
} // end csc232::IsMagicSquare(const csc232::TwoDimArray, int)
...
{
    // TODO: Provide your definition of the InitializeMagicSquare function here (erase this line when done)
} // end csc232::InitializeMagicSquare(csc232::TwoDimArray, int)
...
{
    // TODO: Provide your definition of the IsValidCoordinate function here (erase this line when done)
    return false;
} // end csc232::IsValidCoordinate(int, int)
 ...
 */
void csc232::SetNextLocation(const csc232::TwoDimArray table, std::pair<int, int>& currentLocation, int order)
{
    // TODO: Provide your definition of the SetNextLocation function here (erase this line when done)
    // HINT: This can be facilitated by functions already written such as:
    //      IsValidCoordinate
} // end csc232::SetNextLocation(const csc232::TwoDimArray, std::pair<int, int>, int)
...
{
    // TODO: Provide your definition of the CreateMagicSquare function here (erase this line when done)
    // HINT: This can be facilitated by functions already written such as:
    //      InitializeMagicSquare
    //      SetNextLocation
} // end csc232::CreateMagicSquare(csc232::TwoDimArray, int)
